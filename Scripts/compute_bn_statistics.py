...
caffe_root = '/media/phil/SegNet/caffe-segnet/' 			# Change this to the absolute directory to SegNet Caffe
import sys
...
if __name__ == '__main__':
    ...
    in_h, in_w =(360, 480)		# Image size, hardcoded :)
